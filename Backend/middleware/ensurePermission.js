...
// Resolved merge: unified granular permissions; ensured each permission string is distinct.
// NOTE: Removed 'admin.reports' from warehouse baseline (likely typo); add 'warehouse.reports' if needed later.
const roleBaseline = {
  admin: [
    "admin.dashboard",
    "admin.permissions",
  ...
  warehouse: [
    ...
    "warehouse.logs",
    "warehouse.audit",
    // 'warehouse.reports' // add if reports feature for warehouse exists
  ],
};
