      ...
      <div style={{ flex: '1 1 50%', padding: '3rem' }}>
        ...
        <form onSubmit={handleSubmit} style={{ maxWidth: 480 }}>
          <div style={{ marginBottom: 16 }}>
            <input value={username} onChange={e => setUsername(e.target.value)} placeholder="Username" style={{ width: '100%', padding: '0.5rem 0.75rem', border: '1px solid #e5e7eb', borderRadius: 6 }} />
          </div>
          <div style={{ marginBottom: 16 }}>
            <input value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="Password" style={{ width: '100%', padding: '0.5rem 0.75rem', border: '1px solid #e5e7eb', borderRadius: 6 }} />
          </div>

          {error && <div style={{ marginBottom: 16, color: '#dc2626' }}>{error}</div>}

          <div style={{ marginBottom: 16, textAlign: 'center' }}>
            <button disabled={loading} style={{ background: '#059669', color: '#fff', padding: '0.5rem 1rem', borderRadius: 6, border: 'none' }}>
